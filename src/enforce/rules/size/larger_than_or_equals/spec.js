...
describe('Tests largerThanOrEquals rule', () => {
    ...
    it('Should return true for an values larger than a given value', () => {
        ...
        expect(largerThanOrEquals(6, [1, 2, 3, 4, 5])).to.equal(true);
        expect(largerThanOrEquals({a:1, b:2, c:3, d:4, e:5, f:6}, 'ooh!')).to.equal(true);
    ...
    it('Should return true for an values that equal a given value', () => {
        ...
        expect(largerThanOrEquals({a:1, b:2, c:3, d:4, e:5}, [1, 2, 3, 4, 5])).to.equal(true);
